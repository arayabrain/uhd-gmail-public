...
def main() -> None:
    """main function"""
    src_list = [
        ("20230511", 1, "subject1", "min-overt"),
        ("20230529", 1, "subject1", "overt"),
        ("20230529", 2, "subject1", "covert"),
        ("20230512", 1, "subject2", "min-overt"),
        ("20230512", 2, "subject2", "overt"),
        ("20230516", 1, "subject2", "covert"),
        ("20230523", 1, "subject3", "overt"),
        ("20230523", 2, "subject3", "min-overt"),
        ("20230524", 1, "subject3", "covert"),
        ("20230524", 2, "subject3", "min-overt"),
    ]
    dist_list = [
        # ("20230511", "subject1", ["backup_calibrated_1"], "off-min-overt"),
        # ("20230511", "subject1", ["backup_online_1", "backup_online_2"], "on-min-overt"),
        # ("20230529", "subject1", ["backup_calibrated_1"], "off-overt"),
        # ("20230529", "subject1", ["backup_calibrated_2"], "off-covert"),
        # ("20230529", "subject1", ["backup_online_1"], "on-overt"),
        # ("20230529", "subject1", ["backup_online_2"], "on-covert"),
        # ("20230512", "subject2", ["backup_calibrated_1"], "off-min-overt"),
        # ("20230512", "subject2", ["backup_calibrated_2"], "off-overt"),
        # ("20230512", "subject2", ["backup_online_3"], "on-min-overt"),
        # ("20230512", "subject2", ["backup_online_4"], "on-overt"),
        # ("20230516", "subject2", ["backup_calibrated_1"], "off-covert"),
        # ("20230516", "subject2", ["backup_online_1"], "on-covert"),
        # ("20230523", "subject3", ["backup_calibrated_1"], "off-overt"),
        # ("20230523", "subject3", ["backup_calibrated_2"], "off-min-overt"),
        # ("20230523", "subject3", ["backup_online_2"], "on-overt"),
        # ("20230523", "subject3", ["backup_online_3"], "on-min-overt"),
        # ("20230524", "subject3", ["backup_calibrated_1"], "off-covert"),
        # ("20230524", "subject3", ["backup_calibrated_2"], "off-min-overt"),
        # ("20230524", "subject3", ["backup_online_1"], "on-covert"),
        # ("20230524", "subject3", ["backup_online_2"], "on-min-overt"),
    ]
